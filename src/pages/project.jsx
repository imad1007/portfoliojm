...
export default function Project() {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Mes projets</h2>
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Découvrez une sélection de mes projets, illustrant mon expertise en développement et ma passion pour la création d'applications performantes et innovantes.🚀</p>
      </div> 
